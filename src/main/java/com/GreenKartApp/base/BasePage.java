...
public class BasePage {
	...
	public void initConfigGKAprop() {
		try {
			...
			FileInputStream ip = new FileInputStream(System.getProperty("user.dir") + "\\src\\main\\java\\com\\GreenKartApp\\configFiles\\configGKA.properties");
			configProp.load(ip);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void driverInitialize() {
		...
		if(os.contains("windows")) {
			...
			if(browserName.equals("Chrome")) {
				System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir")+"\\DriverFolder\\Chrome_Driver86\\chromedriver.exe");
